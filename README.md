...
**!!!! This project is out of date and no longer beeing maintained. There are forks available; e.g. [portrino/shopware-sdk](https://github.com/portrino/shopware-sdk) or [neta-io/shopware-sdk](https://github.com/neta-io/shopware-sdk) !!!!**
